...
<div id="wrapper">
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="shome">
            <div class="sidebar-brand-icon rotate-n-15">
                <i class="fas fa-laugh-wink"></i>
            </div>
            <div class="sidebar-brand-text mx-3">我的店铺管理</div>
        </a>
                        ...
                        <form id="goodsform" action="addgoods" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <textarea id="onevalue" name="onevalue" class="form-control"
                                              placeholder="参数值"></textarea>
                                </div>
                                <div style="width: 100%;">
                                    参数二:<input name="paramtwo" class="form-control" placeholder="参数名">
                                    参数值：<textarea id="twovalue" name="twovalue" class="form-control"
                                                  placeholder="参数值"></textarea>
                                </div>
                                <div style="width: 100%;">
                                    参数三：<input name="paramthree" class="form-control" placeholder="参数名">
                                    参数值：<textarea id="threevalue" name="threevalue" class="form-control"
                                                  placeholder="参数值"></textarea>
                                </div>
                            </div>
